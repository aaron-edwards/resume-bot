  ...
  React.useEffect(() => {
    ...
    const render = async () => {
      ...
      try {
        ...
        // Resolve Theme
        const explicitTheme = parsedConfig.theme;
        ...
        mermaid.initialize({
          ...
          themeVariables: parsedConfig.themeVariables,
    ...
    <div className={cn("relative w-full min-h-[100px]", className)}>
      ...
      {status === "success" && svg && (
        <div
          ...
          // biome-ignore lint/security/noDangerouslySetInnerHtml: svg is generated by mermaid.render from a developer-supplied diagram string, not user input
